    ...
    return (
        <div>
            <div className="flex gap-4 items-center mb-8">
                ...
                <div className="py-3 px-4 rounded-full bg-transparent border border-white border-2 text-[15px] shadow hover:shadow-[0_0_15px_0px_#ffffff] duration-200 ease-in-out flex items-center">
                    <button
            ...
            <div className="relative mb-16 text-center">
                <div className="relative">
                    <button
                        className="w-full py-4 px-6 rounded-full bg-white border-white text-black border-2 text-[15px] shadow hover:shadow-[0_0_15px_0px_#ffffff] duration-200 ease-in-out"
                        title="ADD TO CART"
                        onClick={cartHandler}
                    >
                        ADD TO CART
                        <svg
                            className={`animate-spin ml-2 h-4 w-4 text-white ${cartLoading ? "inline" : "hidden"
                                }`}
                            xmlns="http://www.w3.org/2000/svg"
                            fill="none"
                            viewBox="0 0 24 24"
                ...
                {cartMessage && (
                    <Link href="/cart">
                        <button
                            className="w-full mt-10 uppercase py-4 px-6 rounded-full bg-black border-white border-2 text-[15px] shadow hover:shadow-[0_0_15px_0px_#0aba90] duration-200 ease-in-out"
                            title="View Cart"
                        >
                            View Cart
                        </button>
