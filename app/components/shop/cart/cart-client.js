    ...
    return (
        <div className="grid xl:grid-cols-3 gap-8">
            <div className="xl:col-span-2">
                <div className="rounded-[20px] border-2 border-white">
                    <div className="grid grid-cols-3 sm:grid-cols-4 px-4 sm:px-8 py-4 border-b-2 border-white">
                        <p className="text-lg sm:text-2xl font-semibold sm:col-span-2">
                            Product
                        </p>
                        <p className="text-lg sm:text-2xl font-semibold text-center">
                            Quantity
                        </p>
                        <p className="text-lg sm:text-2xl font-semibold text-end">
                            Total
                        </p>
                    </div>
                    <div className="grid grid-cols-3 sm:grid-cols-4 gap-4 sm:gap-8 px-4 sm:px-8 py-8 items-center">
                        {cart?.cartItems ? (
                            ...
                            <p className="col-span-2 text-orange-500">
                ...
                {cart?.cartItems && (
                    <button
                        className="float-right mt-4 py-4 px-6 rounded-full bg-transparent border border-white border-2 text-[15px] shadow hover:shadow-[0_0_15px_0px_#ffffff] duration-200 ease-in-out"
            ...
            <div className="bg-black rounded-[20px] border-2 border-white p-4 sm:p-8 flex flex-col justify-between items-start gap-16">
                <div>
                ...
                <div className="relative w-full">
                    {cart?.cartItems && (
                        <div>
                            <p className="text-white mb-4 leading-tight">
                                Tax included. Shipping calculated at checkout.
                            </p>
                            <button
                                className="mb-4 w-full py-4 px-6 rounded-full bg-white text-black text-[15px] shadow hover:shadow-[0_0_15px_0px_#FFFF] duration-200 ease-in-out"
                                title="CHECKOUT"
