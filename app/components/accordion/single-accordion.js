...
export default function SingleAccordion(props) {
    ...
    return (
        <div className="each-accordion w-full text-left mb-4 border-2 border-[#545454]  bg-black/75">
            <button
                className="w-full text-left text-lg font-normal font-sans py-6 px-6 sm:px-12 flex justify-between items-center gap-4 rounded-[40px]"
                onClick={(e) => {
