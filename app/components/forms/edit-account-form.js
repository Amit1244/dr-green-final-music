        ...
        >
            ...
            <div>
                ...
                <div>
                    <select
                        ...
                        className="appearance-none p-4 rounded-[7px] border-2 border-[#FFFF] font-normal bg-transparent outline-0 w-full font-medium"
                        required
            ...
            <div className="flex justify-center">
                <button
                    type="submit"
                    title="UPDATE"
                    className={`py-4 px-6 rounded-full bg-[#FFFF] shadow text-black border-[#FFFF] border-2 hover:shadow-[0_0_15px_0px_#0ABA90] duration-200 ease-in-out cursor-pointer flex gap-2 justify-center items-center ${isPending ? "pointer-events-none" : ""
                        }`}
                >
                    UPDATE
                    <svg
