...
export default function RegisterForm() {
    ...
    return (
        ...
        >
            <p className="text-2xl md:text-[28px] font-semibold mb-4 tracking-wider">
                Contact Details
            </p>
                ...
                <div>
                    ...
                    <div>
                        <input
                            ...
                            className="p-4 rounded-[7px] border-2 border-[#FFFF]  bg-transparent outline-0 w-full font-medium"
                        />
                    </div>
            ...
            <div className="grid sm:grid-cols-2 gap-4">
                ...
                <div>
                    <label htmlFor="contactNumber" className="tracking-wider">
                    ...
                    <PhoneInput
                        ...
                        className="p-4 rounded-[7px] border-2 border-[#FFFF] text-black bg-transparent outline-0 w-full font-medium"
                        name="contactNumber"
                        id="contactNumber"
                        required
                    />
            ...
            <p className="text-2xl md:text-[28px] font-semibold mb-4 mt-4 tracking-wider">
                Shipping Address
            </p>
            <div className="grid sm:grid-cols-2 gap-4">
                <div>
                    <label htmlFor="address1" className="tracking-wider">
                ...
                <div>
                    <label htmlFor="address2" className="tracking-wider">Address Line 2</label>
                    <div>
                        <input
                            name="address2"
                            maxLength={50}
            ...
            <div className="grid sm:grid-cols-2 gap-4">
                <div>
                    <label htmlFor="landmark" className="tracking-wider">Landmark</label>
                    <div>
                        <input
                            name="landmark"
                            maxLength={50}
            ...
            <div className="grid sm:grid-cols-2 gap-4">
                ...
                <div>
                    <label htmlFor="postalCode" className="tracking-wider">
            ...
            <div>
                <label htmlFor="countryCode" className="tracking-wider">
                ...
                <div>
                    <select
                        ...
                        className="appearance-none p-4 rounded-[7px] border-2 border-[#FFFF] text-black bg-transparent outline-0 w-full font-medium"
                        required
            ...
            <div>
                <label htmlFor="business" className="cursor-pointer tracking-wider">
                    <input
                        name="business"
                        id="business"
                        type="checkbox"
                    ...
                    <div>
                        ...
                        <div>
                            <select
                                ...
                                autoComplete="country"
                                className="appearance-none p-4 rounded-[7px] tracking-wider border-2 border-[#FFFF]  bg-transparent outline-0 w-full font-medium"
                                onChange={(e) =>
            ...
            <div className="flex justify-center items-center gap-4">
                <button
                    type="submit"
                    title="REGISTER"
                    className={`py-4 px-6 rounded-full  tracking-wider border-[#FFFF] border-2 bg-[#FFFF] text-black shadow hover:shadow-[0_0_15px_0px_#FFFF] duration-200 ease-in-out cursor-pointer flex gap-2 justify-center items-center ${isPending ? "pointer-events-none" : ""
                        }`}
                >
                    REGISTER
                    <svg
                ...
                <p className="tracking-wider text-xl">Or</p>
                <Link href="/login">
                    <button
                        title="LOGIN"
                        className="py-4 px-6 tracking-wider  rounded-full bg-transparent  border-[#FFFF] border-2 shadow hover:shadow-[0_0_15px_0px_#FFFF] duration-200 ease-in-out"
                    >
                        LOGIN
                    </button>
                </Link>
            ...
            {state?.success && (
                <p className="text-black text-center">{state?.message}</p>
            )}
        </form>
    );
}
